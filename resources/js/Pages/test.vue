<template>
  ...
  <h3>With Textarea</h3>
  <EmojiPicker picker-type="textarea" @select="onSelectEmoji" class="ml-10 w-96" />
  <br />
  <br />
</template>
